...
public class DDLC implements ActionListener{
	...
	DDLC(){
		...
		warning = new Label("SPOILER ALERT!!!", 36);
		warning.setForeground(Color.RED);
		warning.setBounds(0, 250, 800, 350);
		image = new Label(" ", 1);
		back = new Back();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==b1) {
			Card c1 = new Card("2 (1).png");
			frame.dispose();		
		}
		if(e.getSource()==b2) {
			Card c2 = new Card("2.png");
			frame.dispose();		
		}
		if(e.getSource()==b3) {
			Card c3 = new Card("Copy of 1 (2).png");
			frame.dispose();		
		}
		if(e.getSource()==back) {
